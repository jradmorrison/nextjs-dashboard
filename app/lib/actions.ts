...
export async function createInvoice(prevState: State, formData: FormData) {
  // For forms with many fields it might be usefull to use this method
  // const rawFormData = Object.fromEntries(formData.entries());

  // For small forms the .get(name) method works just fine
  //   const rawFormData = {
...
export async function deleteInvoice(id: string) {
  throw new Error('Failed to delete incvoice');
  try {
